 <footer class="footer">
                    <div class="w-100 clearfix">
                        <span class="text-center text-sm-left d-md-inline-block"><strong>Copyright © 2021 Blue Krystal Technologies v1.0. All Rights Reserved.</strong></span>
                        <span class="float-none float-sm-right mt-1 mt-sm-0 text-center">Crafted with <i class="fa fa-heart text-danger"></i> by <a href="" class="text-dark" target="_blank">BK DOCTORAPP</a></span>
                    </div>
                </footer>
