...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="{{asset('images')}}/{{$user->image}}" style="border-radius: 50%;" height="50px" width="70px">
                    <br>
        ...
        <div class="col-md-9">
            ...
            @csrf
            <div class="card">
                <div class="card-header lead"><b>Appointment Date: {{$date}}</b></div>
                ...
                <div class="card-footer">
                    @if(Auth::check())
                    <button class="btn btn-success" type="submit" style="width: 100%">Book Appointment</button>
                    @else
